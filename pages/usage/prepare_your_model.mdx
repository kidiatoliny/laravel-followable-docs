Before using the **Laravel Followable** package, you need to prepare your model to enable the `follow` and `unfollow` functionality.

This section will guide you through the steps required to set up your model for following and unfollowing.


###  Add the `Follower` Trait
